        ...
        <main>
            <form action="recebe.php" method="POST" style="margin-top: 2vh; width: 42vw; padding: 20px">
                <div class="card border-light mb-3 bg-transparent" style="max-width: 90vw;">
                    <div class="card-header bg-success border-light fs-3 text-light">Cadastro de Fornecedores</div>
                    <div class="card-body text-secondary">
                        <div>
                            <input type="hidden" name="cad" value="fornecedor">
                        </div>

                        <div class="input-group mb-3">
                            <span class="input-group-text" id="basic-addon1"> Nome do Fornecedor *</span>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input name="razao" type="text" class="form-control" placeholder="Razão Social" aria-describedby="basic-addon1" style="background-color: transparent;" required>
                        </div>

                        <div class="input-group mb-3">
                            <span class="input-group-text" id="basic-addon1"> CNPJ *</span>
                            <input name="cnpj" type="text" class="form-control"  aria-describedby="basic-addon1" placeholder="CNPJ" style="background-color: transparent;" required>
                        </div>                        

                        <div class="input-group mb-3">
                            <span class="input-group-text" id="basic-addon1"> Data de Cadastro *</span>
                            <input name="data" type="date" class="form-control" placeholder="Email" aria-describedby="basic-addon1" style="background-color: transparent;" required>
                        </div>
                    </div>
